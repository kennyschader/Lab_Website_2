...
function viewStudentStats(id, toggle){
	...
	if (toggle == 0){
		...
		elementID.style.height = "0";
	}
	if (toggle == 1){
		elementID.style.visibility = "visible";
		elementID.stle.height = "auto";
	}
}
...
function loadStatsPage(){
	...
	var table2 = document.getElementById("winLossTable");
		...
		table2.rows[1].cells[0].innerHTML = winCount;
		table2.rows[1].cells[1].innerHTML = lossCount;
	}
/*
...
function loadPlayersPage(){
	var playerGrab = document.getElementById("player_selector");
	var playerArraySize = players.length;
	for(var i = 0; i<playerArraySize; i++){
		...
		anchor.value = players[i].name;
		playerGrab.appendChild(anchor);
	}
}
